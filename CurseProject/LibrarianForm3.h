...
namespace CurseProject {
	...
	/// </summary>
	public ref class LibrarianForm3 : public System::Windows::Forms::Form
	{
	public:
		LibrarianForm3(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(LibrarianForm3::typeid));
			...
			this->label1->Location = System::Drawing::Point(7, 191);
			...
			this->button2->Location = System::Drawing::Point(0, 223);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(445, 53);
			this->button2->TabIndex = 84;
			this->button2->Text = L"Добавить";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &LibrarianForm3::button2_Click);
			// 
			// textBox4
			// 
